...
beautiful.init( p.c.."themes/zenburn/theme.lua")
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
      { rule = { class = "Corona Simulator.exe" },
...
client.connect_signal("unfocus", function(c) c.border_color = beautiful.border_normal; c.opacity=0.99 end)
