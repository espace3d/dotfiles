...
elseif &background == "dark"
    ...
    hi Cursor gui=reverse guifg=#ff0000 guibg=NONE
    ...
    hi LineNr gui=NONE guifg=#363636 guibg=NONE
    hi MatchParen gui=NONE guifg=NONE guibg=#333333
    hi ModeMsg gui=NONE guifg=#0099ff guibg=NONE
    hi MoreMsg gui=NONE guifg=NONE guibg=NONE
    ...
    hi Question gui=NONE guifg=NONE guibg=NONE
    hi Search gui=NONE guifg=#ff00f6 guibg=#000000
    ...
    hi StatusLine gui=NONE guifg=#000000 guibg=#ff8400
    ...
    hi TabLineSel gui=NONE guifg=#a6a6a6 guibg=#262626
    ...
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=#ff0000 guibg=#000000
    hi WildMenu gui=NONE guifg=#ffffff guibg=#ff0000
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE
    hi PreProc gui=NONE guifg=NONE guibg=NONE
endif
