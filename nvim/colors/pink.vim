...
elseif &background == "dark"
    ...
    hi Conditional gui=NONE guifg=#ff007b guibg=NONE
    hi Constant gui=NONE guifg=#808080 guibg=NONE
    hi Cursor gui=reverse guifg=NONE guibg=NONE
    hi CursorColumn gui=NONE guifg=NONE guibg=#3c3748
    hi CursorLine gui=NONE guifg=NONE guibg=#3c3749
    hi CursorLineNr gui=NONE guifg=#ffffff guibg=NONE
    hi DiffAdd gui=NONE guifg=#68ff0a guibg=#3c3748
    hi DiffChange gui=NONE guifg=NONE guibg=#1a1a1a
    hi DiffDelete gui=NONE guifg=#000000 guibg=#f96c6c
    hi DiffText gui=NONE guifg=NONE guibg=#333333
    hi Directory gui=NONE guifg=#e3e3e3 guibg=NONE
    hi Error gui=NONE guifg=NONE guibg=#260808
    hi ErrorMsg gui=NONE guifg=#130606 guibg=#ffb3d1
    hi FoldColumn gui=NONE guifg=#616161 guibg=NONE
    hi Folded gui=NONE guifg=#707070 guibg=NONE
    hi Ignore gui=NONE guifg=NONE guibg=NONE
    hi IncSearch gui=NONE guifg=#44ff00 guibg=#3c3748
    hi LineNr gui=NONE guifg=#43404f guibg=#343040
    hi MatchParen gui=NONE guifg=NONE guibg=#333333
    hi ModeMsg gui=NONE guifg=NONE guibg=NONE
    hi MoreMsg gui=NONE guifg=NONE guibg=NONE
    hi NonText gui=NONE guifg=#616161 guibg=#343040
    hi Normal gui=NONE guifg=#c5c2cc guibg=#343040
    hi Number gui=bold guifg=#ffffff guibg=NONE
    hi Pmenu gui=NONE guifg=#ababab guibg=#282531
    hi PmenuSbar gui=NONE guifg=NONE guibg=#262626
    hi PmenuSel gui=NONE guifg=#f85d87 guibg=#4e485b
    hi PmenuThumb gui=NONE guifg=NONE guibg=#424242
    hi Question gui=NONE guifg=NONE guibg=NONE
    hi Search gui=NONE guifg=#00fffb guibg=#3c3748
    hi SignColumn gui=NONE guifg=#616161 guibg=NONE
    hi Special gui=NONE guifg=#ababab guibg=NONE
    ...
    hi StatusLine gui=NONE guifg=#ffffff guibg=#4e485b
    hi StatusLineNC gui=NONE guifg=#f5f5f5 guibg=#655e73
    hi StorageClass gui=NONE guifg=#8f8f8f guibg=NONE
    hi String gui=NONE guifg=#cfcfcf guibg=NONE
    hi TabLine gui=NONE guifg=#ffffff guibg=#282531
    hi TabLineFill gui=NONE guifg=NONE guibg=#343040
    hi TabLineSel gui=NONE guifg=#ffffff guibg=#343040
    hi Title gui=NONE guifg=#808080 guibg=NONE
    hi Todo gui=standout guifg=#ff00a6 guibg=#3c3748
    hi Type gui=NONE guifg=#8f8f8f guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#333333 guibg=NONE
    hi Visual gui=NONE guifg=#ff0582 guibg=#3c3748
    hi VisualNOS gui=NONE guifg=NONE guibg=NONE
    hi WarningMsg gui=NONE guifg=#000000 guibg=#f96c6c
    hi WildMenu gui=NONE guifg=#ffffff guibg=#282531
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE
    hi PreProc gui=NONE guifg=NONE guibg=NONE
endif
