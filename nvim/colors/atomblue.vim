...
hi CursorLineNr gui=bold guifg=indianred
...
hi Cursor       guibg=slategrey       guifg=white gui=BOLD
hi VertSplit    guibg=#102030     guifg=#102030   gui=none
hi Folded       guifg=#cccccc     guibg=#405060
hi FoldColumn   guibg=grey30      guifg=tan
hi IncSearch    guifg=slategrey   guibg=khaki
hi LineNr       guifg=#556575     guibg=#304050
hi ModeMsg      guifg=goldenrod
hi MoreMsg      guifg=SeaGreen
hi NonText      guifg=#304050     guibg=#304050 gui=BOLD
hi Question     guifg=springgreen
hi Search       guibg=#ff5a00    guifg=#e8ecf0 
...
hi Comment    guifg=#70d080  gui=BOLD
hi Constant   guifg=#ff6070   gui=BOLD
hi Identifier guifg=#70d080   gui=BOLD
hi Statement  guifg=#6699D0   gui=BOLD
hi PreProc    guifg=indianred gui=BOLD
hi Type       guifg=#8cd0d3   gui=BOLD
hi Special    guifg=#ecad2b   gui=BOLD
hi Delimiter  guifg=#8090a0   gui=BOLD
