...
let s:black = {'gui': '#000000', 'cterm': 168}
let s:grey_line = {'gui': '#46474c', 'cterm': 168}
let s:orange_vif = {'gui': '#ffff00', 'cterm': 168}
...
exec "hi CursorLineNr guifg=". s:white.gui ." guibg=". s:gray_blue.gui ." gui=NONE ctermfg=". s:cyan.cterm ." ctermbg=". s:gray_blue.cterm
...
exec "hi IncSearch guifg=". s:orange_vif.gui ." guibg=". s:black.gui ." gui=NONE ctermfg=". s:cyan.cterm ." ctermbg=". s:dark_gray.cterm
...
exec "hi LineNr guifg=". s:grey_line.gui ." guibg=". s:bg.gui ." gui=NONE ctermfg=". s:fg.cterm ." ctermbg=". s:gray_blue.cterm
...
exec "hi Operator guifg=". s:blue.gui ." guibg=NONE gui=NONE ctermfg=". s:dark_blue.cterm
...
exec "hi Search guifg=". s:orange.gui ." guibg=". s:black.gui ." gui=NONE ctermfg=". s:cyan.cterm ." ctermbg=". s:dark_gray.cterm
"hi SignColumn 
...
exec "hi StorageClass guifg=". s:blue.gui ." guibg=NONE gui=bold ctermfg=". s:dark_blue.cterm
...
exec "hi TabLine guifg=". s:grey_line.gui ." guibg=". s:gray_blue.gui ." gui=NONE ctermfg=". s:bg.cterm ." ctermbg=". s:gray.cterm
exec "hi TabLineFill guifg=". s:grey_line.gui ." guibg=". s:gray_blue.gui ." gui=NONE ctermfg=". s:bg.cterm ." ctermbg=". s:gray.cterm
