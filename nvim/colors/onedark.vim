...
let s:dark_yellow = { "gui": "#FF6600", "cterm": "173", "cterm16": "11" }

let s:blue = { "gui": "#61AFEF", "cterm": "39", "cterm16": "4" } " Alternate cterm: 75
let s:search={ "gui": "#FF006C", "cterm": "39", "cterm16": "4" }
let s:status_line_inactive={ "gui": "#17151A", "cterm": "39", "cterm16": "4" }
let s:status_line={ "gui": "#17151A", "cterm": "39", "cterm16": "4" }
...
let s:black = { "gui": "#1F1D25", "cterm": "235", "cterm16": "0" }
...
call s:h("IncSearch", { "fg": s:search, "bg": s:black }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
...
call s:h("Search", { "fg": s:search, "bg": s:black }) " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
...
call s:h("StatusLine", { "fg": s:white, "bg": s:status_line }) " status line of current window
call s:h("StatusLineNC", { "fg": s:search,"bg" : s:status_line }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
...
call s:h("WildMenu", { "fg": s:search, "bg": s:status_line }) " current match in 'wildmenu' completion
